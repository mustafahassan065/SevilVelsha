...
<section style={{ background: DARK2, padding: 'clamp(80px,10vw,120px) clamp(40px,6vw,80px)' }}>
  ...
  <div style="max-width: 1100px; margin: 0 auto; display: grid; grid-template-columns: 1fr 1fr; gap: clamp(40px,6vw,80px); align-items: center;">
    

    <div style="position: relative;">
      <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(201,168,76,0.15); padding: 24px 20px;">
        <p style="font-family: 'Courier New', monospace; font-size: 11px; font-weight: 700; letter-spacing: 0.25em; text-transform: uppercase; color: #C9A84C; margin: 0 0 20px;">
        ...
        <div>
          <svg width="100%" height="auto" viewBox="0 0 447 120" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: block; width: 100%;">
            <g clip-path="url(#clip0_waveform)">
              <path d="M73.1678 9.99976H413.156" stroke="#222222" stroke-width="0.799972"/>
              <path d="M73.1678 34.9988H413.156" stroke="#222222" stroke-width="0.799972"/>
              <path d="M73.1678 59.998H413.156" stroke="#222222" stroke-width="0.799972"/>
              <path d="M73.1678 84.9971H413.156" stroke="#222222" stroke-width="0.799972"/>
              <path d="M73.1678 109.996H413.156" stroke="#333333" stroke-width="0.999964"/>
              <path d="M73.1678 9.99976V109.996" stroke="#333333" stroke-width="0.999964"/>
              ...
              <path d="M83.1677 94.9966L103.167 81.9971L123.166 69.9975L143.166 54.9981L163.165 64.9977L183.164 49.9983L203.163 74.9974L223.163 41.9985L243.162 57.998L263.161 84.997L283.161 69.9975L303.16 59.9979L323.159 77.9973L343.158 89.9968L363.158 81.9971L383.157 87.9969L403.156 94.9966" stroke="#C9A84C" stroke-width="1.99993"/>
              <path opacity="0.35" d="M83.1677 89.9969L103.167 87.997L123.166 85.9971L143.166 87.997L163.165 86.997L183.164 85.9971L203.163 87.997L223.163 86.997H243.162L263.161 88.997L283.161 87.997L303.16 86.997L323.159 87.997L343.158 88.997L363.158 87.997L383.157 86.997L403.156 89.9969" stroke="#C9A84C" stroke-width="0.999964" stroke-dasharray="4 3"/>
            </g>
            <defs>
    ...
    <div>
      <p style="font-family: 'Courier New', monospace; font-size: 11px; font-weight: 700; letter-spacing: 0.25em; text-transform: uppercase; color: #C9A84C; margin: 0 0 28px;">
        The Breakdown
      </p>
      <h2 style="font-family: 'Times New Roman', serif; font-size: clamp(2rem,4vw,3rem); font-weight: 600; color: #fff; margin: 0 0 20px; line-height: 1.15;">
        What You Will <span style="color: #C9A84C; font-style: italic;">Receive</span>
      </h2>
      <p style="font-size: 15px; color: rgba(255,255,255,0.5); margin: 0 0 36px; line-height: 1.8;">
      ...
      <div style="display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; gap: 12px; align-items: flex-start;">
          <div style="width: 20px; height: 20px; border-radius: 50%; background: #C9A84C; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 1px;">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="#1a1a1a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <span style="font-size: 15px; color: rgba(255,255,255,0.7); line-height: 1.6;">Pitch variation analysis with exact Hz measurements</span>
        </div>
        <div style="display: flex; gap: 12px; align-items: flex-start;">
          <div style="width: 20px; height: 20px; border-radius: 50%; background: #C9A84C; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 1px;">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="#1a1a1a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <span style="font-size: 15px; color: rgba(255,255,255,0.7); line-height: 1.6;">Speaking rate (words per minute) with pacing recommendations</span>
        </div>
        <div style="display: flex; gap: 12px; align-items: flex-start;">
          <div style="width: 20px; height: 20px; border-radius: 50%; background: #C9A84C; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 1px;">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="#1a1a1a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <span style="font-size: 15px; color: rgba(255,255,255,0.7); line-height: 1.6;">Pause placement and duration analysis</span>
        </div>
        <div style="display: flex; gap: 12px; align-items: flex-start;">
          <div style="width: 20px; height: 20px; border-radius: 50%; background: #C9A84C; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 1px;">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="#1a1a1a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <span style="font-size: 15px; color: rgba(255,255,255,0.7); line-height: 1.6;">Personalized vocal exercises for daily practice</span>
        </div>
      </div>
      <a href="#" style="display: inline-block; background: #C9A84C; color: #1a1a1a; font-family: 'Courier New', monospace; font-size: 12px; font-weight: 700; letter-spacing: 0.18em; text-transform: uppercase; padding: 16px 36px; text-decoration: none; margin-top: 40px;">
        Get My Voice Audit →
      </a>
    </div>
  </div>
